    ...
    return (
        <header className='z-50 top-0 py-2 w-full z-999 bg-[#70B5A6] flex justify-between items-center shadow-md'>
            ...
            <div className='flex justify-center items-center mx-2'>
                <Link to={`/user/userprofile/${id}`} className={`flex items-center px-3 mx-2 rounded-lg ${props.active==='profile'?'bg-emerald-100 border-2 border-black shadow-lg':'bg-emerald-200'}`}>
                    <img src={profile} className='w-8 my-3' alt='user' />
